...
const services = [
    {
        ...
        link: "https://github.com/danilusilva?tab=repositories",
    },
    {
        id: 2,
...
const Service = () => {
  return (
    <div className='py-80' id='services'>
        <div className='container mx-auto px-8 md:px-16 lg:px-24'>
            <h2 className='text-4xl font-bold text-center mb-12'>Serviços</h2>
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
                {services.map(service => (
                    <div id='box-services' key={service.id} className='px-6 pb-6 rounded-lg hover:shadow-lg 
